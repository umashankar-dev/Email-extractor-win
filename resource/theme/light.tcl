...
namespace eval ttk::theme::x-light {
    variable version 1.0
    package provide ttk::theme::x-light $version

    ttk::style theme create x-light -parent clam -settings {
        ...
        ttk::style element create Spinbox.uparrow image $images(arrow-up) -width 25 -sticky {}
        ttk::style element create Spinbox.downarrow image $images(arrow-down) -width 25 -sticky {}
        ...
        ttk::style map Treeview \
            -background [list selected #0761b6] \
