...
namespace eval ttk::theme::x-dark {
    variable version 1.0
    package provide ttk::theme::x-dark $version

    ttk::style theme create x-dark -parent clam -settings {
        ...
        ttk::style map Treeview \
            -background [list selected #57c7fe] \
